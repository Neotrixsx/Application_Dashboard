...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update="INSERT INTO `$tablename` ( `browsertitle`, `title`, `detail`, `image`, `time`, `link`, `pubname`, `publogo`, `status`) VALUES ('$blogwebtitle', '$blogtitle', '$blogdetail', '$blogimageurl', '$blogdatetime', '$blogweburl', '$blogpubname', '$blogpublogo', '1')";
